...
#import "SwitchLanguageController.h"
#import "AppLocalizable.h"

@interface SwitchLanguageController () <UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate>
...
@implementation SwitchLanguageController
...
- (void)viewDidLoad {
    ...
    searchBar.placeholder = AppLocalizedString(@"search",@"搜索");
    ...
    AppLocalizedManager.completion = ^(NSString *currentLanguage) {
...
//刷新界面
- (void)changeLanguage {
    self.title = AppLocalizedString(@"switchKey", @"切换语言");
    UIBarButtonItem *item = [[UIBarButtonItem alloc] initWithTitle:AppLocalizedString(@"cancel",@"取消") style:UIBarButtonItemStyleDone target:self action:@selector(cancleButtonAction:)];
...
- (NSString *)ittemCountryLanguage:(NSString *)lang {
    NSString *language = [[AppLocalizable localizable] languageFormat:lang];
...
- (NSString *)ittemCurrentLanguageName:(NSString *)lang {
    NSString *language = [[AppLocalizable localizable] languageFormat:lang];
    //当前语言
    NSString *currentLanguage = AppLocalizedManager.currentLanguage;
    //当前语言下的对应国家语言翻译
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *language = [[AppLocalizable localizable] languageFormat:self.dataAry[indexPath.row]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[AppLocalizable localizable] setUserlanguage:language];
...
- (void)changeSearchBarCancleText:(UISearchBar *)searchBar {
    for (UIView *view in [[searchBar.subviews lastObject] subviews]) {
        if ([view isKindOfClass:[UIButton class]]) {
            ...
            [cancelBtn setTitle:AppLocalizedString(@"cancel",@"取消") forState:UIControlStateNormal];
            [cancelBtn setTitle:AppLocalizedString(@"cancel",@"取消") forState:UIControlStateHighlighted];
            [cancelBtn setTitle:AppLocalizedString(@"cancel",@"取消") forState:UIControlStateSelected];
            [cancelBtn setTitle:AppLocalizedString(@"cancel",@"取消") forState:UIControlStateDisabled];
        }
    }
}
...
- (void)searchBarResultsListButtonClicked:(UISearchBar *)searchBar {
    [AppLocalizedManager setUserlanguage:searchBar.text];
    [self cancleButtonAction:nil];
}
